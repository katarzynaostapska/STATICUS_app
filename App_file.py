...
DATA_PATH = PATH.joinpath("../STATICUS_app/assets").resolve()
#
#
# section definition
#
...
def update_title(user_input1, user_input2, user_input3, button):
    if ctx.triggered:
        ...
        if user_input2 == 'Oslo':
            file_name = '/climate_OSLO_'
        elif user_input2 == 'Trondheim':
            file_name = '/climate_TRD_'
        elif user_input2 == 'Trømso':
            file_name = '/climate_TROMSO_'
        ...
        results = HAM_SOLVER(section_input, file_name)
        result = results[0]
